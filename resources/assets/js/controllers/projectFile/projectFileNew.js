angular.module('app.controllers')
        .controller('ProjectFileNewController',
                ['$scope', '$location', '$routeParams', 'ProjectFile', 'Url', 'Upload', 'appConfig',
                    function ($scope, $location, $routeParams, ProjectFile, Url, Upload, appConfig) {
                        $scope.project_id = $routeParams.id;
                        $scope.save = function () {
                            if ($scope.projectFileForm.$valid) {
